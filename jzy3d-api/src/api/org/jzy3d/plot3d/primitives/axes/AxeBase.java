...
public class AxeBase implements IAxe {
    ...
    public void draw(GL gl, GLU glu, Camera camera) {
        ...
        if (gl.isGL2()) {
            ...
            gl.getGL2().glVertex3d(bbox.getXmin(), bbox.getYmin(), bbox.getZmin());
            gl.getGL2().glVertex3d(bbox.getXmax(), 0, 0);
            gl.getGL2().glColor3f(0.0f, 1.0f, 0.0f); // G
            gl.getGL2().glVertex3d(bbox.getXmin(), bbox.getYmin(), bbox.getZmin());
            gl.getGL2().glVertex3d(0, bbox.getYmax(), 0);
            gl.getGL2().glColor3f(0.0f, 0.0f, 1.0f); // B
            gl.getGL2().glVertex3d(bbox.getXmin(), bbox.getYmin(), bbox.getZmin());
            gl.getGL2().glVertex3d(0, 0, bbox.getZmax());
            gl.getGL2().glEnd();
        } else {
            ...
            GLES2CompatUtils.glVertex3f((float) bbox.getXmin(), (float) bbox.getYmin(), (float) bbox.getZmin());
            GLES2CompatUtils.glVertex3f((float) bbox.getXmax(), 0, 0);
            GLES2CompatUtils.glColor3f(0.0f, 1.0f, 0.0f); // G
            GLES2CompatUtils.glVertex3f((float) bbox.getXmin(), (float) bbox.getYmin(), (float) bbox.getZmin());
            GLES2CompatUtils.glVertex3f(0, (float) bbox.getYmax(), 0);
            GLES2CompatUtils.glColor3f(0.0f, 0.0f, 1.0f); // B
            GLES2CompatUtils.glVertex3f((float) bbox.getXmin(), (float) bbox.getYmin(), (float) bbox.getZmin());
            GLES2CompatUtils.glVertex3f(0, 0, (float) bbox.getZmax());
