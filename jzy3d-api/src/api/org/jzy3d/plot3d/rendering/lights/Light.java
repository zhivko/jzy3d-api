    ...
    public void apply(GL gl, Coord3d scale) {
        if (enabled) {
            ...
            if (gl.isGL2()) {
                ...
                gl.getGL2().glTranslated(position.x * scale.x, position.y * scale.y, position.z * scale.z);
                ...
                GLES2CompatUtils.glTranslatef((float) (position.x * scale.x), (float) (position.y * scale.y), (float) (position.z * scale.z));
